...
const [const <dynamic>[RootRenderer], const <dynamic>[String, const Inject(APP_ID)], const <dynamic>[SanitizationService]],
(RootRenderer _renderer, String _appId, SanitizationService sanitizer) => new AppViewUtils(_renderer, _appId, sanitizer))
)
;
i0.initReflector();
i1.initReflector();
