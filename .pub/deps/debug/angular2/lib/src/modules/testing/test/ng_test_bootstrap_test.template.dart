...
class ViewNgTestBootstrapTestComponent0 extends DebugAppView<import3.NgTestBootstrapTestComponent> {
  ...
  ViewNgTestBootstrapTestComponent0(import6.Injector parentInjector,AppElement declarationEl): super(ViewNgTestBootstrapTestComponent0,renderType_NgTestBootstrapTestComponent,import8.ViewType.COMPONENT,{},parentInjector,declarationEl,ChangeDetectionStrategy.CheckAlways,nodeDebugInfos_NgTestBootstrapTestComponent0);
...
AppView viewFactory_NgTestBootstrapTestComponent0(import6.Injector parentInjector,AppElement declarationEl) {
...
class ViewNgTestBootstrapTestComponentHost0 extends DebugAppView<dynamic> {
  Element _el_0;
  AppElement _appEl_0;
  import3.NgTestBootstrapTestComponent _NgTestBootstrapTestComponent_0_4;
  ViewNgTestBootstrapTestComponentHost0(import6.Injector parentInjector,AppElement declarationEl): super(ViewNgTestBootstrapTestComponentHost0,renderType_NgTestBootstrapTestComponentHost,import8.ViewType.HOST,{},parentInjector,declarationEl,ChangeDetectionStrategy.CheckAlways,nodeDebugInfos_NgTestBootstrapTestComponentHost0);
  AppElement createInternal(dynamic rootSelector) {
    ...
    _NgTestBootstrapTestComponent_0_4 = new import3.NgTestBootstrapTestComponent(this.parentInjector.get(import3.Formatter,null));
    _appEl_0.initComponent(_NgTestBootstrapTestComponent_0_4,[],compView_0);
    compView_0.createComp(projectableNodes,null);
    init([_el_0],[_el_0],[]);
    return _appEl_0;
  }
  dynamic injectorGetInternal(dynamic token,num requestNodeIndex,dynamic notFoundResult) {
    if ((identical(token, import3.NgTestBootstrapTestComponent) && identical(0, requestNodeIndex))) { return _NgTestBootstrapTestComponent_0_4; }
    return notFoundResult;
  }
}
AppView viewFactory_NgTestBootstrapTestComponentHost0(import6.Injector parentInjector,AppElement declarationEl) {
